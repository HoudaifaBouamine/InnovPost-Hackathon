...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapCustomeIdentityApi<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
            ...
            ([FromBody] RegisterDTO registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(MapCustomeIdentityApi)} requires a user store with email support.");
            }
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapCustomeIdentityApi)}-{finalPattern}";
